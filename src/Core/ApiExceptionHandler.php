...
use Hanson\Vbot\Exceptions\ApiArgumentException;
use Hanson\Vbot\Exceptions\ApiCookiesException;
use Hanson\Vbot\Exceptions\ApiFrequencyException;
use Hanson\Vbot\Exceptions\ApiLogoutException;
use Hanson\Vbot\Exceptions\ApiTicketException;
